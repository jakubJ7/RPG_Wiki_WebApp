    ...
    public partial class InitalCreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArmorType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemRarity", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiscType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharacterCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsAccepted = table.Column<bool>(type: "bit", nullable: false),
                    CharacterTypeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemRarityId = table.Column<int>(type: "int", nullable: true),
                    ...
                    MiscTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Item_ArmorType_ArmorTypeId",
                        column: x => x.ArmorTypeId,
                        principalTable: "ArmorType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Item_ItemRarity_ItemRarityId",
                        column: x => x.ItemRarityId,
                        principalTable: "ItemRarity",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Item_MiscType_MiscTypeId",
                        column: x => x.MiscTypeId,
                        principalTable: "MiscType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Item_WeaponType_WeaponTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Item_ArmorTypeId",
                table: "Item",
                column: "ArmorTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Item_ItemRarityId",
                table: "Item",
                column: "ItemRarityId");

            migrationBuilder.CreateIndex(
                name: "IX_Item_MiscTypeId",
                table: "Item",
                column: "MiscTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Item_WeaponTypeId",
                table: "Item",
                column: "WeaponTypeId");
        }
